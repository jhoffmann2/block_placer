...
execute @e[type=armor_stand,tag=random_block] ~ ~ ~ scoreboard players tag @e[name=editor,type=armor_stand] add tempRepeat
execute @e[name=editor,type=armor_stand,tag=!tempRepeat] ~ ~ ~ scoreboard players tag @a remove loading
execute @e[name=editor,type=armor_stand,tag=!tempRepeat] ~ ~ ~ execute @a[tag=ui7] ~ ~ ~ function dungeon_genorator:tellraw/build_functions
execute @e[name=editor,type=armor_stand,tag=!tempRepeat] ~ ~ ~ scoreboard objectives remove placeBlockNum
scoreboard players tag @e[name=editor,type=armor_stand] remove tempRepeat
