...
scoreboard players operation @s[name=block1Memory] setLoot = slot5Block1 Loot
scoreboard players operation @s[name=block2Memory] setLoot = slot5Block2 Loot
scoreboard players operation @s[name=block3Memory] setLoot = slot5Block3 Loot
scoreboard players operation @s[name=block4Memory] setLoot = slot5Block4 Loot
scoreboard players operation @s[name=block5Memory] setLoot = slot5Block5 Loot
scoreboard players operation @s[name=block6Memory] setLoot = slot5Block6 Loot
scoreboard players operation @s[name=block7Memory] setLoot = slot5Block7 Loot
scoreboard players operation @s[name=block8Memory] setLoot = slot5Block8 Loot
scoreboard players operation @s[name=block9Memory] setLoot = slot5Block9 Loot
scoreboard players operation @s[name=block10Memory] setLoot = slot5Block10 Loot
