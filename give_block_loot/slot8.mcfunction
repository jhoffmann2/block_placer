...
scoreboard players operation @s[name=block1Memory] setLoot = slot8Block1 Loot
scoreboard players operation @s[name=block2Memory] setLoot = slot8Block2 Loot
scoreboard players operation @s[name=block3Memory] setLoot = slot8Block3 Loot
scoreboard players operation @s[name=block4Memory] setLoot = slot8Block4 Loot
scoreboard players operation @s[name=block5Memory] setLoot = slot8Block5 Loot
scoreboard players operation @s[name=block6Memory] setLoot = slot8Block6 Loot
scoreboard players operation @s[name=block7Memory] setLoot = slot8Block7 Loot
scoreboard players operation @s[name=block8Memory] setLoot = slot8Block8 Loot
scoreboard players operation @s[name=block9Memory] setLoot = slot8Block9 Loot
scoreboard players operation @s[name=block10Memory] setLoot = slot8Block10 Loot
