...
scoreboard players operation @s[name=block1Memory] setLoot = slot4Block1 Loot
scoreboard players operation @s[name=block2Memory] setLoot = slot4Block2 Loot
scoreboard players operation @s[name=block3Memory] setLoot = slot4Block3 Loot
scoreboard players operation @s[name=block4Memory] setLoot = slot4Block4 Loot
scoreboard players operation @s[name=block5Memory] setLoot = slot4Block5 Loot
scoreboard players operation @s[name=block6Memory] setLoot = slot4Block6 Loot
scoreboard players operation @s[name=block7Memory] setLoot = slot4Block7 Loot
scoreboard players operation @s[name=block8Memory] setLoot = slot4Block8 Loot
scoreboard players operation @s[name=block9Memory] setLoot = slot4Block9 Loot
scoreboard players operation @s[name=block10Memory] setLoot = slot4Block10 Loot
