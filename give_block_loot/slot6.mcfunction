...
scoreboard players operation @s[name=block1Memory] setLoot = slot6Block1 Loot
scoreboard players operation @s[name=block2Memory] setLoot = slot6Block2 Loot
scoreboard players operation @s[name=block3Memory] setLoot = slot6Block3 Loot
scoreboard players operation @s[name=block4Memory] setLoot = slot6Block4 Loot
scoreboard players operation @s[name=block5Memory] setLoot = slot6Block5 Loot
scoreboard players operation @s[name=block6Memory] setLoot = slot6Block6 Loot
scoreboard players operation @s[name=block7Memory] setLoot = slot6Block7 Loot
scoreboard players operation @s[name=block8Memory] setLoot = slot6Block8 Loot
scoreboard players operation @s[name=block9Memory] setLoot = slot6Block9 Loot
scoreboard players operation @s[name=block10Memory] setLoot = slot6Block10 Loot
