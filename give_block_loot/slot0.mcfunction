...
scoreboard players operation @s[name=block1Memory] setLoot = slot0Block1 Loot
scoreboard players operation @s[name=block2Memory] setLoot = slot0Block2 Loot
scoreboard players operation @s[name=block3Memory] setLoot = slot0Block3 Loot
scoreboard players operation @s[name=block4Memory] setLoot = slot0Block4 Loot
scoreboard players operation @s[name=block5Memory] setLoot = slot0Block5 Loot
scoreboard players operation @s[name=block6Memory] setLoot = slot0Block6 Loot
scoreboard players operation @s[name=block7Memory] setLoot = slot0Block7 Loot
scoreboard players operation @s[name=block8Memory] setLoot = slot0Block8 Loot
scoreboard players operation @s[name=block9Memory] setLoot = slot0Block9 Loot
scoreboard players operation @s[name=block10Memory] setLoot = slot0Block10 Loot
