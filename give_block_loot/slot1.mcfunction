...
scoreboard players operation @s[name=block1Memory] setLoot = slot1Block1 Loot
scoreboard players operation @s[name=block2Memory] setLoot = slot1Block2 Loot
scoreboard players operation @s[name=block3Memory] setLoot = slot1Block3 Loot
scoreboard players operation @s[name=block4Memory] setLoot = slot1Block4 Loot
scoreboard players operation @s[name=block5Memory] setLoot = slot1Block5 Loot
scoreboard players operation @s[name=block6Memory] setLoot = slot1Block6 Loot
scoreboard players operation @s[name=block7Memory] setLoot = slot1Block7 Loot
scoreboard players operation @s[name=block8Memory] setLoot = slot1Block8 Loot
scoreboard players operation @s[name=block9Memory] setLoot = slot1Block9 Loot
scoreboard players operation @s[name=block10Memory] setLoot = slot1Block10 Loot
