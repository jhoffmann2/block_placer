...
scoreboard players operation @s[name=block1Memory] setLoot = slot3Block1 Loot
scoreboard players operation @s[name=block2Memory] setLoot = slot3Block2 Loot
scoreboard players operation @s[name=block3Memory] setLoot = slot3Block3 Loot
scoreboard players operation @s[name=block4Memory] setLoot = slot3Block4 Loot
scoreboard players operation @s[name=block5Memory] setLoot = slot3Block5 Loot
scoreboard players operation @s[name=block6Memory] setLoot = slot3Block6 Loot
scoreboard players operation @s[name=block7Memory] setLoot = slot3Block7 Loot
scoreboard players operation @s[name=block8Memory] setLoot = slot3Block8 Loot
scoreboard players operation @s[name=block9Memory] setLoot = slot3Block9 Loot
scoreboard players operation @s[name=block10Memory] setLoot = slot3Block10 Loot
