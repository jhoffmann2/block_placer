...
execute @s[tag=editBlock1] ~ ~ ~ scoreboard players add slot24Block1 Loot 1
scoreboard players operation slot24Block1 Loot += max Loot
scoreboard players operation slot24Block1 Loot %= max Loot
execute @s[tag=editBlock2] ~ ~ ~ scoreboard players add slot24Block2 Loot 1
scoreboard players operation slot24Block2 Loot += max Loot
scoreboard players operation slot24Block2 Loot %= max Loot
execute @s[tag=editBlock3] ~ ~ ~ scoreboard players add slot24Block3 Loot 1
scoreboard players operation slot24Block3 Loot += max Loot
scoreboard players operation slot24Block3 Loot %= max Loot
execute @s[tag=editBlock4] ~ ~ ~ scoreboard players add slot24Block4 Loot 1
scoreboard players operation slot24Block4 Loot += max Loot
scoreboard players operation slot24Block4 Loot %= max Loot
execute @s[tag=editBlock5] ~ ~ ~ scoreboard players add slot24Block5 Loot 1
scoreboard players operation slot24Block5 Loot += max Loot
scoreboard players operation slot24Block5 Loot %= max Loot
execute @s[tag=editBlock6] ~ ~ ~ scoreboard players add slot24Block6 Loot 1
scoreboard players operation slot24Block6 Loot += max Loot
scoreboard players operation slot24Block6 Loot %= max Loot
execute @s[tag=editBlock7] ~ ~ ~ scoreboard players add slot24Block7 Loot 1
scoreboard players operation slot24Block7 Loot += max Loot
scoreboard players operation slot24Block7 Loot %= max Loot
execute @s[tag=editBlock8] ~ ~ ~ scoreboard players add slot24Block8 Loot 1
scoreboard players operation slot24Block8 Loot += max Loot
scoreboard players operation slot24Block8 Loot %= max Loot
execute @s[tag=editBlock9] ~ ~ ~ scoreboard players add slot24Block9 Loot 1
scoreboard players operation slot24Block9 Loot += max Loot
scoreboard players operation slot24Block9 Loot %= max Loot
execute @s[tag=editBlock10] ~ ~ ~ scoreboard players add slot24Block10 Loot 1
