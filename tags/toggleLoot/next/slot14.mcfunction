...
execute @s[tag=editBlock1] ~ ~ ~ scoreboard players add slot14Block1 Loot 1
scoreboard players operation slot14Block1 Loot += max Loot
scoreboard players operation slot14Block1 Loot %= max Loot
execute @s[tag=editBlock2] ~ ~ ~ scoreboard players add slot14Block2 Loot 1
scoreboard players operation slot14Block2 Loot += max Loot
scoreboard players operation slot14Block2 Loot %= max Loot
execute @s[tag=editBlock3] ~ ~ ~ scoreboard players add slot14Block3 Loot 1
scoreboard players operation slot14Block3 Loot += max Loot
scoreboard players operation slot14Block3 Loot %= max Loot
execute @s[tag=editBlock4] ~ ~ ~ scoreboard players add slot14Block4 Loot 1
scoreboard players operation slot14Block4 Loot += max Loot
scoreboard players operation slot14Block4 Loot %= max Loot
execute @s[tag=editBlock5] ~ ~ ~ scoreboard players add slot14Block5 Loot 1
scoreboard players operation slot14Block5 Loot += max Loot
scoreboard players operation slot14Block5 Loot %= max Loot
execute @s[tag=editBlock6] ~ ~ ~ scoreboard players add slot14Block6 Loot 1
scoreboard players operation slot14Block6 Loot += max Loot
scoreboard players operation slot14Block6 Loot %= max Loot
execute @s[tag=editBlock7] ~ ~ ~ scoreboard players add slot14Block7 Loot 1
scoreboard players operation slot14Block7 Loot += max Loot
scoreboard players operation slot14Block7 Loot %= max Loot
execute @s[tag=editBlock8] ~ ~ ~ scoreboard players add slot14Block8 Loot 1
scoreboard players operation slot14Block8 Loot += max Loot
scoreboard players operation slot14Block8 Loot %= max Loot
execute @s[tag=editBlock9] ~ ~ ~ scoreboard players add slot14Block9 Loot 1
scoreboard players operation slot14Block9 Loot += max Loot
scoreboard players operation slot14Block9 Loot %= max Loot
execute @s[tag=editBlock10] ~ ~ ~ scoreboard players add slot14Block10 Loot 1
